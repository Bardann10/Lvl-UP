  ...
  return (
    <div className="space-y-6 pb-24 lg:pb-6">
      <PageHeader
        ...
        description="Review your consistency and task planning by day with a clear monthly rhythm."
      />

      <div className="ui-card rounded-[2rem] p-4 sm:p-6">
      ...
      <div className="ui-card rounded-[2rem] p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            {dailyGoals.length === 0 ? (
              ...
              <div className="mt-3 space-y-2">
                {dailyGoals.map((goal) => {
                  ...
                  return (
                    <div key={goal.id} className="flex items-center justify-between rounded-2xl border border-white/10 bg-slate-900/55 px-3 py-3">
                      <div>
            ...
            {selectedTasks.length === 0 ? (
              ...
              <div className="mt-3 space-y-2">
                {selectedTasks.map((task) => (
                  <div key={task.id} className="rounded-2xl border border-white/10 bg-slate-900/55 px-3 py-3">
